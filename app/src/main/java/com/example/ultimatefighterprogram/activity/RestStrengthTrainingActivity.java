...
public class RestStrengthTrainingActivity extends AppCompatActivity {
    ...
    private static final String[] NEXT_STRENGTH_WORKOUTS = {
            "NEXT: Squats", "NEXT: Lunges", "NEXT: Boat Hold",
            "NEXT: Jumping Jacks", "NEXT: Sit-Ups", "NEXT: Push-Ups"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rest_strength_training);
        ...
        rest1.setText(NEXT_STRENGTH_WORKOUTS[workoutIndex]);
    ...
    private void startNextExercise() {
        if (workoutIndex < NEXT_STRENGTH_WORKOUTS.length - 1) {
            workoutIndex++;
            Intent intent = new Intent(RestStrengthTrainingActivity.this, StrengthTrainingActivity.class);

...
import com.example.ultimatefighterprogram.databinding.ActivityWorkoutBinding;
...
public class WorkoutActivity extends AppCompatActivity {
    ...
    private static final String[] WORKOUTS = {
            "Jab-Cross-Jab", "Jab-Hook-Hook", "Jab-Cross-Lean", "Jab-Cross-Duck-Cross",
            "Jab-Uppercut", "Jab-Cross-Hook-Cross", "Jab-Lean-Hook"
    };
    private static final int[] VIDEOS = {
            R.raw.jabcrossjab, R.raw.jabhookhook, R.raw.jabcrosslean, R.raw.jabcrossduckcross,
            R.raw.jabup, R.raw.jabcrosshookcross, R.raw.jableanhook
    };
    ...
    private void setUpWorkout() {
        binding.exerciseName.setText(WORKOUTS[workoutIndex]);

        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + VIDEOS[workoutIndex]);
        ...
        countDownTimer = new CountDownTimer(time, 1000) {
            ...
            public void onFinish() {
                if (isInWorkout) {
                    ...
                    Intent intent = new Intent(WorkoutActivity.this, Rest10Activity.class);

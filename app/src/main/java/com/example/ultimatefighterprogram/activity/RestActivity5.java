...
import com.example.ultimatefighterprogram.databinding.ActivityRest5Binding;

public class RestActivity5 extends AppCompatActivity {

    private ActivityRest5Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize binding
        binding = ActivityRest5Binding.inflate(getLayoutInflater());
        ...
        binding.skipbtn5.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void startRestTimer(long time) {
        restCountDownTimer = new CountDownTimer(time, 1000) {
            public void onTick(long millisUntilFinished) {
                binding.restTimertext5.setText("00:" + (millisUntilFinished / 1000));
            }
    ...
    private void startNextExercise() {
        Intent intent = new Intent(RestActivity5.this, ShadowBoxing6.class); // Replace 'MainActivity' with your next activity
